...
def main(map_file):
    ...
    m.add_traj(t)
    m.to_JSON(r"C:\Users\Etienne\Documents\Code\MultiAgent\Assignment_2\traj22XBis.JSON")
...
if (__name__ == "__main__"):
    main(r"C:\Users\Etienne\Documents\Code\MultiAgent\Assignment_2\P22_X.json")